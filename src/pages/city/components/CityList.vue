      ...
      <div class="content">
        <div class="selections">
            ...
            <ul>
                ...
                <li v-for="(city,index) in hotCities" :key="index" @click="handleClickCity(city)"> {{ city.name }} </li>
            </ul>
        </div>
        ...
        <div class="cities">
            <ul v-for="(item,index) in cities" :key="item.index">
                ...
                <li :data-city="city.name" v-for="city in item" :key="city.id" @click="handleClickCity(city)"> {{ city.name }} </li>
            </ul>
        </div>
      </div>
  </div>
